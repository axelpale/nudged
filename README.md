...
<img src="doc/transformation-types.jpg" alt="Types of transformation estimators" width="500"/>

_**Figure**: Available types of transformation estimators. The black points and connecting arrows represent movement of two control points. Given the control points, *nudged* estimates a transformation. The image pairs represents the effect of the resulting transformation. To emphasize the effect of the estimator type, the control points and the initial image positions are kept the same for each type._
